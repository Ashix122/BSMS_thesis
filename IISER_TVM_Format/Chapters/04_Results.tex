...
For the family of initial data considered in this work, the best-tuned critical parameter is found to be $(p^* = 4.110 \pm 0.003)$. Despite this comparatively modest level of tuning, we are still able to extract a critical exponent of approximately $(\gamma \approx)$ [value], demonstrating the robustness of the scaling behaviour even away from extremely fine tuning.
