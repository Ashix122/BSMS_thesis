...
\begin{figure}[!!hbt]
    \centering
    \includegraphics[scale=0.4]{../notebooks/figure.pdf}
    \caption{The apparent horizon (AH) is overlaid on the Kretschmann scalar for a cropped region of the computational domain. As the tuning parameter approaches the critical threshold, the detected horizons deviate from spherical symmetry and exhibit a characteristic “peanut”-like shape. }
    \label{horizon_peanut}
\end{figure}
